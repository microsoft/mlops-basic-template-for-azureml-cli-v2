def call(String resourceGroup, String workspace) {
    ...
    withCredentials([string(credentialsId: 'mik-sp-app-id', variable: 'app_id'), string(credentialsId: 'sp-tennant-id', variable: 'tennant_id'), string(credentialsId: 'mik-sp-password', variable: 'password')]) {
